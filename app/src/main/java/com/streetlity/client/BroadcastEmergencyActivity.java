...
public class BroadcastEmergencyActivity extends AppCompatActivity {
    ...
    /*
    same as find a repairman but use different criteria
     */
    float currLat;
    float currLon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("");
            ...
            final View dialogView = View.inflate(this ,R.layout.dialog_instruction_emergency, null);
            ...
            public void onClick(View v) {
                ...
                if (isOther) {
                    if (edtReason.getText().toString().equals("")) {
                        Toast toast = Toast.makeText(BroadcastEmergencyActivity.this, R.string.please_select_reason, Toast.LENGTH_LONG);
        ...
        imgAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!edtReason.getText().equals("")) {
                    ...
                    Toast toast = Toast.makeText(BroadcastEmergencyActivity.this, R.string.empty_reason, Toast.LENGTH_LONG);
                    TextView tv = (TextView) toast.getView().findViewById(android.R.id.message);
                    tv.setTextColor(Color.RED);
    ...
    public void sendBroadcast(final String reason, final String phone, final String note, double lat, double lon) {
        ...
        /*
        get the emergency repairman nearby
         */
        Retrofit retro = new Retrofit.Builder().baseUrl(MyApplication.getInstance().getMaintenanceURL())
                .addConverterFactory(GsonConverterFactory.create()).build();
        final MapAPI tour = retro.create(MapAPI.class);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.code() == 200) {
                    ...
                    try {
                        ...
                        /*
                        calculate distance of the repair man and add to a list to send request,
                        up to 10km while there is less than 5 repairman
                         */
                        while (count < 5) {
                            count = 0;
                            idList.clear();
