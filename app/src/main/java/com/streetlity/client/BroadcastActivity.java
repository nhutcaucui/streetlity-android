...
public class BroadcastActivity extends AppCompatActivity {
    /*
    Activity for finding repairman
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        Check if this is the first time this activity is opened to show instruction
        This reset when logout
         */
        ...
        /*
        Show the instrution dialog when click
         */
        ...
        /*
        Get last known location, right now the latitude and longitude isn't used
         */
        ...
        /*
        Add reasons, reason can be add and remove so user can make his/her own list
         */
        ...
        /*
        Show the "Other" edit text if user choose the "Other" option from the spinner
         */
        ...
        /*
        Confirm button trigger send broadcast after checking if user use a reason in the list or manually type in
         */
        ...
        /*
        Use to close the gif screen and deny the order
         */
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                broadcastCount++;
                /*
                if user cancel 3 times in a row close the activity and proceed to mark user as spam,
                prevent user to prevent this function for a while
                 */
                if(broadcastCount>=3){
    ...
    /*
    Set a listener to handle when a repairman accept the order
     */
    @Override
...
/*
Send a request to deny the order to the server
 */
    ...
    public void sendBroadcast(final String reason, final String phone, final String note, double lat, double lon) {
        ...
        /*
        Show a waiting screen with a gif while waiting for a repairman to accept the order
         */
        ...
        /*
        Send request to get the nearby maintenance stores
         */
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.code() == 200) {
                    ...
                    try {
                        ...
                        /*
                        Find maintenance stores that have repairman sign up, up to 10km if there's less then 3 stores
                         */
                        while (count < 3) {
                            count = 0;
                            idList.clear();
                        ...
                        /*
                        If no store is found, close the waiting screen and notify the user no available repairman
                        else make a request to create the order
                         */
                        if (count > 0) {
...
//                                                finish();
                                                ...
                                                /*
                                                if after 20s, no repairman accept the order, the order is canceled
                                                 */
...
//                                                });
    ...
    */
    ...
    /*
    close activity when tap the back arrow
     */
    ...
    /*
    open a dialog telling user that a repairman is found
     */
    public void foundAMaintainer(Intent intent){
        notFound = false;

        /*
        save the id of order so that user can open it again in case the user close the app
         */
        ...
        /*
        open the map and the chat screen
         */
    ...
    /*
    Trigger when the listener is trigger
     */
    ...
    /*
    stop the countdown if user close the activity
     */
    @Override
